...
if(($detect->isMobile())||($detect->isTablet())){
    header('Location: http://venux.com/');
    die();
}
?>
<!doctype html>
...
<head>
    ...
    <script>
    _atrk_opts = { atrk_acct:"oV1gk1a0SnB1L7", domain:"venux.com",dynamic: true};
    (function() { var as = document.createElement('script'); as.type = 'text/javascript'; as.async = true; as.src = "https://d31qbv1cthcecs.cloudfront.net/atrk.js"; var s = document.getElementsByTagName('script')[0];s.parentNode.insertBefore(as, s); })();
    </script>
    <noscript><img src="https://d5nxst8fruw4z.cloudfront.net/atrk.gif?account=oV1gk1a0SnB1L7" style="display:none" height="1" width="1" alt="" /></noscript>
...
<body>
        ...
        <div id="noJsErrorWrapper">
            <div id="jsError" class="center">
                ...
                <div id="jsErrorMsg">
                    ...
                    <p class="m-top20"><a href="/">View our 2D website</a>.</p>
                </div>
            </div>
        </div>
    </noscript>
    ...
    <div id="topCopy" class="loading">
        <p>2013-2014 Venux LLC. Copyright. All rights reserved.</p>
        <p>
            <a href="/">2D Website</a> | <span id="privacyPolicy">Privacy Policy</span> | <span id="termsConditions">Terms & Conditions</span>
        </p>
    </div>
